...
| **LmBridge** | Internal class that translates between OpenAI API format and VS Code Language Model API format. |
| **Server** | Internal class wrapping Express HTTP server with OpenAI-compatible routes. |
